...
import com.gwtapps.gwtspring.shared.FieldVerifier;
 ...
 * for details.
 */
public class GwtTestGwtApp extends GWTTestCase {

  /**
   * Must refer to a valid module that sources this class.
   */
  public String getModuleName() {
    return "com.gwtapps.gwtspring.GwtAppJUnit";
  }
  ...
  public void testGreetingService() {
    ...
    target.setServiceEntryPoint(GWT.getModuleBaseURL() + "GwtApp/greet");
    ...
    employeeService.greetServer("GWT User", new AsyncCallback<String>() {
